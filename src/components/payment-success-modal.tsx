...
const PaymentSuccessModal = () => {
  ...
  const { data, isPending } = useQuery({
    ...
    refetchInterval: (query) => {
      return query.state.data?.plan === "PREMIUM" ? false : 1000
    },
  })
  ...
  const isPaymentSuccessful = data?.plan === "PREMIUM"
          ...
          <>
            <div className="mt-6 flex flex-col items-center gap-1 text-center">
              ...
              <p className="text-gray-600 text-sm/6 text-pretty">
                Thank you for upgrading to Premium and supporting AppSignal.
                Your account has been upgraded.
              </p>
            </div>

            <div className="mt-8 w-full mb-2 md:mb-0">
